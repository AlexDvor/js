...
// Массив объектов
// В стандартный набор повседневных задач разработчика входит манипуляция 
// массивом однотипных объектов.Это значит что все объекты в массиве гарантированно
// будут иметь одинаковый набор свойств, но с разными значениями.
...
// один параметр productName - название продукта.Функция ищет объект продукта
...
// console.log(calculateTotalPrice('Рада'));
...
// const find = {completed,category,priority,...data}
// return find;
...
// Операция ... (rest) позволяет собрать группу независимых элементов в новую 
// коллекцию.Синтаксически это близнец операции распыления, но отличить их просто
...
// При этом оригинальные яблоки останутся на полу, а в ящике будет копия
// каждого яблока.
...
//  const atTheOldToadIndex = this.potions.indexOf(potionName);
//      this.potions.splice(atTheOldToadIndex, 1, );
//   },
// };
...
// // console.table(atTheOldToad.addPotion({ name: 'Невидимка', price: 620 }));
// // console.table(atTheOldToad.removePotion('Дыхание дракона'));
// console.table(atTheOldToad.updatePotionName('Дыхание дркона', 'Полиморф'));
