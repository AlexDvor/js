...
// чётных чисел из массива numbers,
...
// console.log(getUsersWithEyeColor(ourClients, 'blue')); //Moore Hensley, Sharlene Bush и Carey Barr.
// -------------------------------------------------------------------------------------------------------------------------------------------------------
...
//   const min = users.filter(user => user.age > minAge && user.age < maxAge );
//   return min;
...
//   const c = users.filter(user => user.friends.includes(friendName));
//   return c;
   
// };
// Пиши код выше этой строки

// console.log(getUsersWithFriend(b,'Briana Decker'));
...
// console.log(getUserWithEmail(userMail,'shereeanthony@kog.com'));
